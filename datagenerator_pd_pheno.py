...
class DataGenerator(tf.keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        X_pheno, y = self.__data_generation(list_IDs_temp)
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            #X_geno[i,] = self.__process_geno(ID, self.geno_file).reshape((40237, 1))
            y[i,] = dataset["Group_numeric"].values

        return X_pheno, y  # This line will take care of outputing the inputs for training and the labels
